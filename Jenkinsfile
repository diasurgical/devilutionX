...
def build_sdl2_ttf(TARGET, SYSROOT) {
	...
	sh "cd SDL2_ttf-2.0.15/ && FT2_CFLAGS=\"-I${SYSROOT}/include/freetype2\" FT2_LIBS=\"-lfreetype\" ./configure --host=${TARGET} --prefix=${SYSROOT}" //FT2_CONFIG=${SYSROOT}/include/freetype2/freetype/config/ftconfig.h
