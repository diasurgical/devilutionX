...
def build_sdl2_ttf(TARGET, SYSROOT) {
	...
	sh "cd SDL2_ttf-2.0.15/build && PKG_CONFIG_PATH=${SYSROOT}/lib/pkgconfig/ cmake .. -DCMAKE_INSTALL_PREFIX=${SYSROOT} -DCMAKE_MODULE_PATH=${SOURCE_PATH}/CMake/" // -DCMAKE_INSTALL_LIBDIR=${SYSROOT}/lib -DCMAKE_INSTALL_INCLUDEDIR=${SYSROOT}/include
	try {
