...
Download [the latest DevilutionX release](https://github.com/diasurgical/devilutionX/releases) and extract the contents to the location or your choice, or [build from source](./docs/building.md)
