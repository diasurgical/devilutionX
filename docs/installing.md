...
- Open https://gamr13.github.io/ in the browser and install the Gamr13 Appstore
- Install DevilutionX and FTP-server from the Gamr13 Appstore
- Open DevilutionX
- Open and start the FTP-server
- Copy the `/LOCALFOLDER/*Gamr13*DevilutionX*/LocalState/diasurgical/devilution` using a FTP-client
