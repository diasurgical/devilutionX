...
xcopy /E /I /Y assets\* ..\uwp-project\Assets\
...
powershell "Get-Childitem -Path . -Include Microsoft.VCLibs.x64.*.appx, devilutionX_*_x64.appxbundle -File -Recurse | Compress-Archive -DestinationPath devilutionx-xbox-one.zip"