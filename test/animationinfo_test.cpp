	...
	RunAnimationTest(
	    {
	        ...
	        // Animation stopped cause PM_DoAttack would stop the Animation "if (plr[pnum].animationInfo.currentFrame == plr[pnum]._pAFrames - 1) {"
	    });
}
	...
	RunAnimationTest(
	    {
	        ...
	        // Start of repeated attack, cause plr[pnum].animationInfo.currentFrame > plr[myplr]._pAFNum
	...
	RunAnimationTest(
	    {
	        ...
	        new RenderingData(0.6f, 1),
	        new RenderingData(0.8f, 1),
	        // Animation stopped cause PM_DoBlock would stop the Animation "if (plr[pnum].animationInfo.currentFrame >= plr[pnum]._pBFrames) {"
	    });
}
	...
	RunAnimationTest(
	    {
	        ...
	        new RenderingData(0.6f, 7),
	        new RenderingData(0.8f, 7),
	        // Animation stopped cause PM_DoGotHit would stop the Animation "if (plr[pnum].animationInfo.currentFrame >= plr[pnum]._pHFrames) {"
	    });
}
