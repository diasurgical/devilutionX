...
TEST_F(InvTest, ItemSize)
{
	...
	InitializeItem(testItem, ItemID::RuneStone);
	EXPECT_EQ(GetInventorySize(testItem), Size(1, 1));
	InitializeItem(testItem, ItemID::GreySuit);
	...
	InitializeItem(testItem, ItemID::AuricAmulet);
	EXPECT_EQ(GetInventorySize(testItem), Size(1, 1));
	...
	InitializeItem(testItem, ItemID::Gold);
	EXPECT_EQ(GetInventorySize(testItem), Size(1, 1));
}
