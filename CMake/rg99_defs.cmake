...
# Optimize for size: We need all the RAM we can get.
set(CMAKE_CXX_FLAGS "${CMAKE_CXX_FLAGS} -Os")

# Must stream all audio due to RAM constraints.
set(STREAM_ALL_AUDIO ON)

# Must use a tiny audio buffer due to RAM constraints.
set(DEFAULT_AUDIO_BUFFER_SIZE 128)
...
set(SDL1_VIDEO_MODE_FLAGS SDL_YUV444|SDL_HWSURFACE|SDL_FULLSCREEN)
