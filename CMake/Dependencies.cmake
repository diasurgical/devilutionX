...
elseif(USE_SDL1)
  ...
  #  set_property(TARGET SDL2_lib PROPERTY IMPORTED_LOCATION "${SDL2_DIR}/VisualC-WinRT/x64/Release/SDL-UWP/SDL2.lib")
  #  set_property(TARGET SDL2_lib PROPERTY INTERFACE_INCLUDE_DIRECTORIES "${SDL2_DIR}/include")
...
if(UWP_LIB)
  ...
  elseif(TARGET SDL2::SDL2-static)
    target_link_libraries(DevilutionX::SDL INTERFACE ${SDL2_MAIN} SDL2::SDL2-static)
  endif()
endif()
