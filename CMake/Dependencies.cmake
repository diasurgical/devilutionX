...
if(NOT DEFINED DEVILUTIONX_SYSTEM_ABSL)
  find_package(absl 20210324 QUIET)
  if(absl_FOUND)
    message("-- Found absl ${absl_VERSION}")
  else()
    message("-- Suitable system absl package not found, will use absl from source")
    set(DEVILUTIONX_SYSTEM_ABSL OFF)
  endif()
endif()
dependency_options("absl" DEVILUTIONX_SYSTEM_ABSL ON DEVILUTIONX_STATIC_ABSL)
if(DEVILUTIONX_SYSTEM_ABSL)
