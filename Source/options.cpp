...
GameplayOptions::GameplayOptions()
    ...
    , disableCripplingShrines("Disable Crippling Shrines", OptionEntryFlags::None, N_("Disable Crippling Shrines"), N_("When enabled Cauldrons, Fascinating Shrines, Goat Shrines, Ornate Shrines, Sacred Shrines and Murphy's Shrines (Hellfire only) are not able to be clicked on and labeled as disabled."), false)
