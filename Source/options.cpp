...
void LoadOptions()
{
	...
	sgOptions.Controller.bSimplifiedScheme = GetIniBool("Controller", "Simplified Gamepad Scheme", false);
...
void SaveOptions()
{
	...
	SetIniValue("Controller", "Simplified Gamepad Scheme", sgOptions.Controller.bSimplifiedScheme);
