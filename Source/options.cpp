...
void LoadOptions()
{
	...
	sgOptions.Gameplay.nSPanelHAlign = GetIniInt("Game", "Sub Panel Horizontal Alignment", 0);
	sgOptions.Gameplay.nSPanelVAlign = GetIniInt("Game", "Sub Panel Vertical Alignment", 0);
...
void SaveOptions()
{
	...
	SetIniValue("Game", "Sub Panel Horizontal Alignment", sgOptions.Gameplay.nSPanelHAlign);
	SetIniValue("Game", "Sub Panel Vertical Alignment", sgOptions.Gameplay.nSPanelVAlign);
