...
void ShowProgress(interface_mode uMsg)
{
	...
	case WM_DIABSETLVL:
		...
		FreeGameMem();
		IncProgress();
		LoadGameLevel(true, ENTRY_SETLVL);
		IncProgress();
		break;
	case WM_DIABRTNLVL:
		IncProgress();
		...
		IncProgress();
		GetReturnLvlPos();
		LoadGameLevel(true, ENTRY_RTNLVL);
		IncProgress();
		break;
	case WM_DIABWARPLVL:
		IncProgress();
		...
		GetPortalLevel();
		IncProgress();
		LoadGameLevel(true, ENTRY_WARPLVL);
		IncProgress();
		break;
	case WM_DIABTOWNWARP:
		IncProgress();
		...
		assert(plr[myplr].plrlevel == currlevel);
		IncProgress();
		LoadGameLevel(true, ENTRY_TWARPDN);
		IncProgress();
		break;
	case WM_DIABTWARPUP:
		IncProgress();
		...
		assert(plr[myplr].plrlevel == currlevel);
		IncProgress();
		LoadGameLevel(true, ENTRY_TWARPUP);
		IncProgress();
		break;
	case WM_DIABRETOWN:
		IncProgress();
