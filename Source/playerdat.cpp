...
const PlayerData PlayersData[] = {
	// clang-format off
// HeroClass                 className,       classPath,   baseStr, baseMag,    baseDex,   baseVit,    maxStr, maxMag,     maxDex,    maxVit, blockBonus, lvlUpLife, lvlUpMana,  chrLife,                     chrMana,                     itmLife,                      itmMana, NFrames,  WFrames, BFrames, DFrames, SFrames, HFrames, TNFrames, TWFrames, SFNum, skill,                  swStand, swWalk, swAttack, swBow, swHit, swBlock, swLightning, swFire, swMagic, swDeath            

// TRANSLATORS: Player Block start
/* HeroClass::Warrior */   { N_("Warrior"),   "warrior",        30,      10,         20,        25,       250,     50,         60,       100,         30,  (2 << 6),  (1 << 6), (2 << 6),                    (1 << 6),                    (2 << 6),                     (1 << 6),      10,       8,       2,      20,      20,       6,        20,        8,    14, SpellID::ItemRepair,         96,     96,      128,    96,    96,      96,          96,     96,      96,     128 },
/* HeroClass::Rogue */     { N_("Rogue"),     "rogue",          20,      15,         30,        20,        55,     70,        250,        80,         20,  (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64),       8,       8,       4,      20,      16,       7,        20,        8,    12, SpellID::TrapDisarm,         96,     96,      128,   128,    96,      96,          96,     96,      96,     128 },
/* HeroClass::Sorcerer */  { N_("Sorcerer"),  "sorceror",       15,      35,         15,        20,        45,    250,         85,        80,         10,  (1 << 6),  (2 << 6), (1 << 6),                    (2 << 6),                    (1 << 6),                     (2 << 6),       8,       8,       6,      20,      12,       8,        20,        8,     8, SpellID::StaffRecharge,      96,     96,      128,   128,    96,      96,         128,    128,     128,     128 },
/* HeroClass::Monk */      { N_("Monk"),      "monk",           25,      15,         25,        20,       150,     80,        150,        80,         25,  (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64),       8,       8,       3,      20,      18,       6,        20,        8,    13, SpellID::Search,            112,    112,      130,   128,    98,      98,         114,    114,     114,     160 },
/* HeroClass::Bard */      { N_("Bard"),      "rogue",          20,      20,         25,        20,       120,    120,        120,       100,         25,  (2 << 6),  (2 << 6), (1 << 6), static_cast<int>(1.5F * 64), static_cast<int>(1.5F * 64), static_cast<int>(1.75F * 64),       8,       8,       4,      20,      16,       7,        20,        8,    12, SpellID::Identify,           96,     96,      128,   128,    96,      96,          96,     96,      96,     128 },
/* HeroClass::Barbarian */ { N_("Barbarian"), "warrior",        40,       0,         20,        25,       255,      0,         55,       150,         30,  (2 << 6),  (0 << 6), (2 << 6),                    (1 << 6), static_cast<int>(2.5F * 64),                     (1 << 6),      10,       8,       2,      20,      20,       6,        20,        8,    14, SpellID::Rage,               96,     96,      128,    96,    96,      96,          96,     96,      96,     128 },
	// clang-format on
};

const PlayerAttackAnimData PlayersAttackAnimData[] = {
	// clang-format off
// HeroClass                AFramesUnarmed, AFNumUnarmed, AFramesUnarmedShield, AFNumUnarmedShield, AFramesSword, AFNumSword, AFramesSwordShield, AFNumSwordShield, AFramesBow, AFNumBow, AFramesAxe, AFNumAxe, AFramesMace, AFNumMace, AFramesMaceShield, AFNumMaceShield, AFramesStaff, AFNumStaff
/* HeroClass::Warrior */   {            16,            9,                   16,                  9,           16,          9,                 16,                9,         16,       11,         20,       10,          16,         9,                16,               9,           16,         11 },
/* HeroClass::Rogue */     {            18,           10,                   18,                 10,           18,         10,                 18,               10,         12,        7,         22,       13,          18,        10,                18,              10,           16,         11 },
/* HeroClass::Sorcerer */  {            20,           12,                   16,                  9,           16,         12,                 16,               12,         20,       16,         24,       16,          16,        12,                16,              12,           16,         12 },
/* HeroClass::Monk */      {            12,            7,                   12,                  7,           16,         12,                 16,               12,         20,       14,         23,       14,          16,        12,                16,              12,           13,          8 },
/* HeroClass::Bard */      {            18,           10,                   18,                 10,           18,         10,                 18,               10,         12,       11,         22,       13,          18,        10,                18,              10,           16,         11 },
/* HeroClass::Barbarian */ {            16,            9,                   16,                  9,           16,          9,                 16,                9,         16,       11,         20,        8,          16,         8,                16,               8,           16,         11 },
	// clang-format on
};
