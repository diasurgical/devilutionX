...
const PlayerData PlayersData[] = {
	// clang-format off
// HeroClass                 className,       classPath,   baseStr, baseMag,    baseDex,   baseVit,    maxStr, maxMag,     maxDex,    maxVit, blockBonus, lvlUpLife, lvlUpMana,  chrLife,                     chrMana,                     itmLife,                      itmMana, NFrames,  WFrames, BFrames, DFrames, SFrames, HFrames, TNFrames, TWFrames, SFNum, skill

// TRANSLATORS: Player Block start
/* HeroClass::Warrior */   { N_("Warrior"),   "warrior",        30,      10,         20,        25,       250,     50,         60,       100,         30,  (2 << 6),  (2 << 6), (2 << 6),                    (1 << 6),                    (2 << 6),                     (1 << 6),      10,       8,       2,      20,      20,       6,        20,        8,    14, SpellID::ItemRepair    },
/* HeroClass::Rogue */     { N_("Rogue"),     "rogue",          20,      15,         30,        20,        55,     70,        250,        80,         20,  (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64),       8,       8,       4,      20,      16,       7,        20,        8,    12, SpellID::TrapDisarm    },
/* HeroClass::Sorcerer */  { N_("Sorcerer"),  "sorceror",       15,      35,         15,        20,        45,    250,         85,        80,         10,  (1 << 6),  (2 << 6), (1 << 6),                    (2 << 6),                    (1 << 6),                     (2 << 6),       8,       8,       6,      20,      12,       8,        20,        8,     8, SpellID::StaffRecharge },
/* HeroClass::Monk */      { N_("Monk"),      "monk",           25,      15,         25,        20,       150,     80,        150,        80,         25,  (2 << 6),  (2 << 6), (1 << 6),                    (1 << 6), static_cast<int>(1.5F * 64),  static_cast<int>(1.5F * 64),       8,       8,       3,      20,      18,       6,        20,        8,    13, SpellID::Search        },
/* HeroClass::Bard */      { N_("Bard"),      "rogue",          20,      20,         25,        20,       120,    120,        120,       100,         25,  (2 << 6),  (2 << 6), (1 << 6), static_cast<int>(1.5F * 64), static_cast<int>(1.5F * 64), static_cast<int>(1.75F * 64),       8,       8,       4,      20,      16,       7,        20,        8,    12, SpellID::Identify      },
/* HeroClass::Barbarian */ { N_("Barbarian"), "warrior",        40,       0,         20,        25,       255,      0,         55,       150,         30,  (2 << 6),  (0 << 6), (2 << 6),                    (1 << 6), static_cast<int>(2.5F * 64),                     (1 << 6),      10,       8,       2,      20,      20,       6,        20,        8,    14, SpellID::Rage          },
	// clang-format on
};
