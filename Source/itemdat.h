...
enum class ItemID : int16_t { // TODO defines all indexes in AllItemsList
	...
	StuddedLeatherArmor,
	RingMail,
	MediumHeavyArmorFirst = RingMail,
	ChainMail,
	ScaleMail,
	BreastPlate,
	SplintMail,
	...
	GothicPlate,
	FullPlateMail,
	MediumHeavyArmorLast = FullPlateMail, // Previously in DevilutionX, Bucklers couldn't appear in Shareware. After this enum class is implemented, items in Shareware may morph.
	Buckler,
	SmallShield,
	LargeShield,
	KiteShield,
