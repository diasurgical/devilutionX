...
const SpellData spelldata[] = {
	...
	{ SPL_HEALING,          5, STYPE_MAGIC,     P_("spell", "Healing"),                   1,         1, false,     true,            17, IS_CAST8, { MIS_HEAL,          MIS_NULL,   MIS_NULL },        3,        1,        20,        40,      1000,         50 },
	...
	{ SPL_TOWNPORTAL,         35, STYPE_MAGIC,     P_("spell", "Town Portal"),               3,         3, true,      false,           20, IS_CAST6, { MIS_TOWN,          MIS_NULL,   MIS_NULL },        3,       18,         8,        12,      3000,        200 },
	{ SPL_STONECURSE,        60, STYPE_MAGIC,     P_("spell", "Stone Curse"),               6,         5, true,      false,           51, IS_CAST2, { MIS_STONE,         MIS_NULL,   MIS_NULL },        3,       40,         8,        16,     12000,        800 },
	{ SPL_INFRAVISION,        40, STYPE_MAGIC,     P_("spell", "Infravision"),              -1,        -1, false,     false,           36, IS_CAST8, { MIS_INFRA,         MIS_NULL,   MIS_NULL },        5,       20,         0,         0,         0,        600 },
	{ SPL_PHASING,  12, STYPE_MAGIC,     P_("spell", "Phasing"),                   7,         6, false,     false,           39, IS_CAST2, { MIS_RNDTELEPORT,   MIS_NULL,   MIS_NULL },        2,        4,        40,        80,      3500,        200 },
	...
	{ SPL_CHAINLIGHTNING,        30, STYPE_LIGHTNING, P_("spell", "Chain Lightning"),           8,         7, false,     false,           54, IS_CAST2, { MIS_CHAIN,         MIS_NULL,   MIS_NULL },        1,       18,        20,        60,     11000,        750 },
	{ SPL_FLAMEWAVE,         35, STYPE_FIRE,      P_("spell", "Flame Wave"),                9,         8, true,      false,           54, IS_CAST2, { MIS_WAVE,          MIS_NULL,   MIS_NULL },        3,       20,        20,        40,     10000,        650 },
	{ SPL_DOOMSERPENTS,      0, STYPE_LIGHTNING, P_("spell", "Doom Serpents"),            -1,        -1, false,     false,            0, IS_CAST2, { MIS_NULL,          MIS_NULL,   MIS_NULL },        0,        0,        40,        80,         0,          0 },
	{ SPL_BLOODRITUAL,       0, STYPE_MAGIC,     P_("spell", "Blood Ritual"),             -1,        -1, false,     false,            0, IS_CAST2, { MIS_NULL,          MIS_NULL,   MIS_NULL },        0,        0,        40,        80,         0,          0 },
	{ SPL_NOVA,         60, STYPE_MAGIC,     P_("spell", "Nova"),                     14,        10, false,     false,           87, IS_CAST4, { MIS_NOVA,          MIS_NULL,   MIS_NULL },        3,       35,        16,        32,     21000,       1300 },
	{ SPL_INVISIBILITY,     0, STYPE_MAGIC,     P_("spell", "Invisibility"),             -1,        -1, false,     false,            0, IS_CAST2, { MIS_NULL,          MIS_NULL,   MIS_NULL },        0,        0,        40,        80,         0,          0 },
	{ SPL_INFERNO,        11, STYPE_FIRE,      P_("spell", "Inferno"),                   3,         2, true,      false,           20, IS_CAST2, { MIS_FLAMEC,        MIS_NULL,   MIS_NULL },        1,        6,        20,        40,      2000,        100 },
	{ SPL_GOLEM,       100, STYPE_FIRE,      P_("spell", "Golem"),                    11,         9, false,     false,           81, IS_CAST2, { MIS_GOLEM,         MIS_NULL,   MIS_NULL },        6,       60,        16,        32,     18000,       1100 },
	{ SPL_RAGE,     15, STYPE_MAGIC,     P_("spell", "Rage"),                     -1,        -1, false,     false,            0, IS_CAST8, { MIS_BLODBOIL,      MIS_NULL,   MIS_NULL },        1,        1,         0,         0,         0,          0 },
	...
	{ SPL_APOCALYPSE,       150, STYPE_FIRE,      P_("spell", "Apocalypse"),               19,        15, false,     false,          149, IS_CAST2, { MIS_APOCA,         MIS_NULL,   MIS_NULL },        6,       90,         8,        12,     30000,       2000 },
	...
	{ SPL_ITEMREPAIR,        0, STYPE_MAGIC,     P_("spell", "Item Repair"),              -1,        -1, false,     true,            -1, IS_CAST6, { MIS_REPAIR,        MIS_NULL,   MIS_NULL },        0,        0,        40,        80,         0,          0 },
	{ SPL_STAFFRECHARGE,      0, STYPE_MAGIC,     P_("spell", "Staff Recharge"),           -1,        -1, false,     true,            -1, IS_CAST6, { MIS_RECHARGE,      MIS_NULL,   MIS_NULL },        0,        0,        40,        80,         0,          0 },
	{ SPL_TRAPDISARM,        0, STYPE_MAGIC,     P_("spell", "Trap Disarm"),              -1,        -1, false,     false,           -1, IS_CAST6, { MIS_DISARM,        MIS_NULL,   MIS_NULL },        0,        0,        40,        80,         0,          0 },
	{ SPL_ELEMENTAL,      35, STYPE_FIRE,      P_("spell", "Elemental"),                 8,         6, false,     false,           68, IS_CAST2, { MIS_ELEMENT,       MIS_NULL,   MIS_NULL },        2,       20,        20,        60,     10500,        700 },
	{ SPL_CHARGEDBOLT,         6, STYPE_LIGHTNING, P_("spell", "Charged Bolt"),              1,         1, true,      false,           25, IS_CAST2, { MIS_CBOLT,         MIS_NULL,   MIS_NULL },        1,        6,        40,        80,      1000,         50 },
	{ SPL_HOLYBOLT,         7, STYPE_MAGIC,     P_("spell", "Holy Bolt"),                 1,         1, true,      false,           20, IS_CAST2, { MIS_HBOLT,         MIS_NULL,   MIS_NULL },        1,        3,        40,        80,      1000,         50 },
	...
	{ SPL_BLOODSTAR,        25, STYPE_MAGIC,     P_("spell", "Blood Star"),               14,        13, false,     false,           70, IS_CAST2, { MIS_FLARE,         MIS_NULL,   MIS_NULL },        2,       14,        20,        60,     27500,       1800 },
	...
	{ SPL_RUNEOFIMMOLATION, 255, STYPE_MAGIC,     P_("spell", "Rune of Immolation"),       -1,        -1, true,      false,           48, IS_CAST8, { MIS_RUNEIMMOLAT,   MIS_NULL,   MIS_NULL },        1,       10,        40,        80,      8000,        300 },
