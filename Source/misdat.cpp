...
tl::expected<MissileData::AddFn, std::string> ParseMissileAddFn(std::string_view value)
{
	...
	if (value == "AddItemMissile") return AddItemMissile;
	...
	if (value == "AddItemLightning") return AddItemLightning;
	...
	if (value == "AddItemChargedBolt") return AddItemChargedBolt;
...
tl::expected<MissileData::ProcessFn, std::string> ParseMissileProcessFn(std::string_view value)
{
	...
	if (value == "ProcessItemLightning") return ProcessItemLightning;
	...
	if (value == "ProcessItemMissile") return ProcessItemMissile;
