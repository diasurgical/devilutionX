...
bool MonsterMHit(int pnum, int m, int mindam, int maxdam, int dist, missile_id t, bool shift)
{
	...
	AddFloatingNumber(pnum == MyPlayerId, monster.position.tile, GetFloatingNumberTypeFromMissile(t), dam, m);
...
bool MonsterTrapHit(int m, int mindam, int maxdam, int dist, missile_id t, bool shift)
{
	...
	AddFloatingNumber(true, monster.position.tile, GetFloatingNumberTypeFromMissile(t), dam, m);
