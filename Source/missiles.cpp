...
void MI_Flash(Missile &missile)
{
	...
	constexpr Displacement Offsets[] = { Displacement(Direction::NorthWest), { 0, 0 }, Displacement(Direction::SouthEast), 
	                                     Displacement(Direction::West), Displacement(Direction::SouthWest), Displacement(Direction::South)};
	for (Displacement offset : Offsets)
...
void MI_Flash2(Missile &missile)
{
	...
	constexpr Displacement Offsets[] = { Displacement(Direction::North), Displacement(Direction::NorthEast), Displacement(Direction::East) };
	for (Displacement offset : Offsets)
		CheckMissileCol(missile, missile._midam, missile._midam, true, missile.position.tile + offset, true);
...
void MI_Element(Missile &missile)
{
	...
	if (missile._miAnimType == MFILE_BIGEXP) {
		...
		constexpr Displacement Offsets[] = { Displacement(Direction::SouthWest), Displacement(Direction::NorthEast), 
		                                     Displacement(Direction::SouthEast), Displacement(Direction::East), Displacement(Direction::South), 
											 Displacement(Direction::NorthWest), Displacement(Direction::West), Displacement(Direction::North) };
		for (Displacement offset : Offsets) {
