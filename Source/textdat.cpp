...
*/
	...
	{ N_("Yet out it figured you haven't?! Understand could you even so simple it make to tried I! Chamber butcher the from spell portal town the cast!"),
	    1, 5, TSFX_PEGBOY22 },
	{ N_("Mmm, where is that stupid map? It was supposed to be between the rock and the tree before the bridge. It should be right... Oh, hello there. Didn't, uh, see you standing there..."),
	    1, 5, TSFX_PEGBOY23 },
	...
	{ N_("Pssst... over here... I have something very special for sale today! I'm not exactly sure what it is, but I can just tell that it's great. I'm gonna offer you a bargain - a thousand gold takes it. Right now, no questions, and no returns!"),
	    1, 5, TSFX_PEGBOY28 },
	{ N_("Hey, you... Yeah, I'm talking to you! I... acquired this strange book. I know it must do something big, but you need a crystal eye piece to read it, so it's useless to me. However, I would be willing to trade you this rare and mystical tome, uh for just a few things."),
	    1, 5, TSFX_PEGBOY29 },
	{ N_("Look, this very special book that I have can be yours for so little. Don't tell anyone what a great deal I'm giving you or it would ruin my reputation."),
	    1, 5, TSFX_PEGBOY30 },
	{ N_("Amazing, you actually found everything I wanted! Well, here's the book, but you're going to have to find a crystal eye piece to read it. Good luck!"),
	    1, 5, TSFX_PEGBOY31 },
	...
	{ "Remember, the right device in my hands can become quite powerful. |",
	    1, 5, TSFX_WITCH34 },
	{ "This is amazing! The mystic energies in this crystal are powerful, but unfocused. If you could find for me a specific staff to channel this power through... |",
	    1, 5, TSFX_WITCH35 },
