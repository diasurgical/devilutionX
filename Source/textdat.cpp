...
*/
	...
	{ "I admit that I too have seen these strange lights, but I have not felt pulled towards them. I'll be sure to steer clear of them, and I'll tell everyone that visits here to do likewise. |",
	    true, TSFX_SMITH6 },
	{ "A bold tale indeed. My limited time beneath the cathedral leaves me poorly equipped to offer you any help of this. But, as always, you'll find Cain well versed in legends and folklore. |",
	    true, TSFX_SMITH8 },
	...
	{ "Farnham speaks of a place that exists, at least in legend. Warriors would go to a place at the edge of Hell to gird themselves for battle against the armies of darkness. If the stories are true, untold treasures could lie upon this island of the sunless sea. |",
	    true, TSFX_SMITH15 },
	{ "Ah, you speak of an ancient and evil weapon. Thread lightly in this area, about legends of Shadowfang are as black as a moonless winter night. Crafted within the Hellforge. Shadowfang can rend the very soul from whoever it strikes. I do not envy you if is in your mind to defeat the one who wields it. May light protect you, brave hero. |",
	    true, TSFX_SMITH16 },
	{ "Oh man, look! A caravan stopped just outside of the village and it's taking supplies to the lands of east. Certain items will bring a special prize, if you can get them for me. |",
	    true, TSFX_SMITH27 },
	{ "We can both turn a nice profit if you think you can deliver the right goods to me. What do you see? |",
	    true, TSFX_SMITH28 },
	{ You are just in time. A caravan is leaving tonight! Here is your cut, friend. |",
	    true, TSFX_SMITH29 },
	{ "I belive I may find a way to greatly improve some weapons. If you can bring me what I need, I'll be willing to try out my Idea. And if it works, its yours! |",
	    true, TSFX_SMITH30 },
	{ "I still think I can improve the right weapon! |",
	    true, TSFX_SMITH31 },
	{ "Let me just do this, and this, and this. Ahh, it works! Take this back and give it a try. |",
	    true, TSFX_SMITH32 },
	{ "I still think I can improve the right weapon! Unfortunately, I don't have what it needs, thought. If you can possibly bring me what I require, the first one is yours! |",
	    true, TSFX_SMITH33 },
	...
	{ "Good find! See if this works any better for you. |",
	    true, TSFX_SMITH35 },
	{ "If you come across any enchanted equipment, I could try to learn how it's crafted and then use those methods for my own creations. I should probably start with something easy. |",
	    true, TSFX_SMITH36 },
	{ "I still think that I can strip the knowledge of enchantments, if you bring me a certain item. |",
	    true, TSFX_SMITH37 },
	{ "Thank you! Oh, great and mighty customer uh-uh champion. This will take some study. Done! |",
	    true, TSFX_SMITH38 },
	{ "Keep your eyes open for a figurine made of iron, I have uncovered some old records concerning a specific type of figurine and the secrets of metalcraft inner it holds. |",
	    true, TSFX_SMITH39 },
	{ "I know that the right figurine could be quite powerful. If you see what I am looking for, get it and bring it to me straight way. |",
	    true, TSFX_SMITH40 },
	{ "The secrets of this metal are fantastic! Oh, oh, I can make the right item gleam with power. |",
	    true, TSFX_SMITH41 },
	{ "If you deliver to me the right items so I can combine them with this metal, I could craft something worthy of warriors of heaven! |",
	    true, TSFX_SMITH42 },
	{ "Your efforts are not in vain. It seems that all years is I would hoped. I trust you will find this useful in your battles bellow. |",
	    true, TSFX_SMITH43 },
*/
};
