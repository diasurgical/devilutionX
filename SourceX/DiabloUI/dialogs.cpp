...
UI_Item OKCANCEL_DIALOG[] = {
	{ { 180, 168, 280, 144 }, UI_IMAGE, UIS_NULL, 0, "ui_art\\spopup.pcx" },
...
UI_Item PROGRESS_DIALOG[] = {
	...
	{ { 205, 220, 228, 38 }, UI_IMAGE, UIS_NULL, 0, "ui_art\\prog_bg.pcx" },
...
UI_Item SPAWNERR_DIALOG[] = {
	{ { 140, 199, 400, 177 }, UI_TEXT, UIS_NULL, 0, "The Rogue and Sorcerer are only available in the full retail version of Diablo. For ordering information call (800) 953-SNOW." },
	{ { 230, 407, 180, 43 }, UI_BUTTON, UIS_NULL, 0, "OK" },
};
